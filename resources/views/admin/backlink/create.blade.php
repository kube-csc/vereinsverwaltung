              ...
              <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
                  <div class="p-6">
                      <div class="flex items-center">
                            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">Neuer Backlink</div>
                      </div>
                      ...
                      <div class="ml-12">
                          <div class="mt-2 text-sm text-gray-500">
                            ...
                            <div style="text-align: left">
                              ...
                              <form class="my-4" autocomplete="off" action="{{ route('backlink.store') }}" method="post">
                                @csrf
                                <div>
                                    ...
                                    id="backlink" placeholder="Backlink" name="backlink" value="{{ old('backlink') }}">
                               ...
                               <div>
                                   ...
                                   id="neueUrl" placeholder="neue Url" name="neueUrl" value="{{ old('neueUrl') }}">
                                   <small class="form-text text-danger">{!! $errors->first('neueUrl') !!}</small>
                               </div>
                                <div class="py-2">
                                <button type="submit" class="p-2 bg-blue-500 w-40 rounded shadow text-white">neue Backlink anlegen</button>
                                </div>
                            </form>
                            <br>
