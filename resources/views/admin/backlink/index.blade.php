                      ...
                      <div class="ml-12">
                          <div class="mt-2 text-sm text-gray-500">
                            ...
                            <div class="my-4 flex">
                               ...
                               <a class="p-2 m-2 bg-blue-500 w-40 rounded shadow text-white" href="/Backlink/relevant"><i class="fas fa-arrow-circle-up"></i>relevante Backlinks von alten Web-Layouts</a>
                               <a class="p-2 m-2 bg-blue-500 w-40 rounded shadow text-white" href="/Backlink/benutzt"><i class="fas fa-arrow-circle-up"></i>relevante Weiterleitungen von alten Web-Layouts</a>
                            </div>
