            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
              ...
              <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                  ...
                  <div class="mt-6 text-gray-500">
                    Bitte gebe eine neue {{env('Menue_Abteilung')}} an.
                  </div>
              ...
              <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
                  <div class="p-6">
                      <div class="flex items-center">
                            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">Neue {{env('Menue_Abteilung')}}</div>
                      </div>
                          ...
                          <div class="mt-2 text-sm text-gray-500">
                            ...
                            <div style="text-align: left">
                              ...
                              <form class="my-4" autocomplete="off" action="{{ route('sportSection.store') }}" method="post">
                                @csrf
                                <div>
                                    <label for="abteilung">{{env('Menue_Abteilung')}}:</label>
                                ...
                                <div class="py-2">
                                <button type="submit" class="p-2 bg-blue-500 w-80 rounded shadow text-white">neue {{env('Menue_Abteilung')}} anlegen</button>
                                </div>
                            </form>
                            <br>
