<x-app-layout>
    ...
    <div class="max-w-2xl mx-auto py-8">
        <div class="bg-white shadow rounded-lg p-6">
            <h1 class="text-2xl font-bold mb-4">Team melden</h1>
            <form method="POST" action="{{ route('regattaTeam.store') }}">
                @csrf
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="beschreibung" id="beschreibung" rows="6" class="form-input w-full">{{ old('beschreibung', $regattaTeam->beschreibung) }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="kommentar" id="kommentar" rows="3" class="form-input w-full">{{ old('kommentar', $regattaTeam->kommentar) }}</textarea>
                ...
                <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded transition duration-150 ease-in-out hover:bg-blue-700 hover:scale-105">Team melden</button>
