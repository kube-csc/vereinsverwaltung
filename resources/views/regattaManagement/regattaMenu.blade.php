                    ...
                    <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2">
                                <div class="p-6">
                                    ...
                                    @if(Session::has('regattaSelectUeberschrift'))
                                        <div class="ml-12">
                                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                                <div class="rounded border shadow p-3 my-2 bg-blue-200" onclick="window.location.replace('/Regatta/Einstellungen')">
                                                    <div class="justify-between my-2">
                                                        <div class="flex">
                                                            <p class="font-bold text-lg">
                        ...
                        @else
                            <div class="p-6 text-center text-gray-600">
                                {{ __('Sie haben keine Berechtigung für diesen Bereich. Erforderlicher Status: 3.') }}
                            </div>
                        @endif
                    </div>
