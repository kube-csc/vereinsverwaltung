...
class SportSectionSeeder extends Seeder
{
    ...
    public function run()
    {
       ...
       DB::table('sport_sections')
        ->insert(
          [
            array('ID' => '1','abteilung' => 'Verein','abteilungTeamBezeichnung' => 'Vorstand','event_id' => '1','status' => '1','sportSection_id' => NULL,'bild' => '','domain' => '','bearbeiter_id' => '1','user_id' => '1','farbe' => '','created_at' => '2021-03-28 13:06:42','updated_at' => '2021-03-28 13:06:42'),
