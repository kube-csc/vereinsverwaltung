            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
              ...
              <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                  ...
                  <div class="mt-6 text-gray-500">
                   In diesem Bereich werden die {{env('MENUE_ABTEILUNG')}} des Vereins angelegt und bearbeitet.
                   Für jede {{env('MENUE_ABTEILUNG')}} gibt es ein Beschreibungsfeld für Informationen.
              ...
              <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
                  <div class="p-6">
                      <div class="flex items-center">
                            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">{{env('MENUE_ABTEILUNG')}}</div>
                      </div>
                          ...
                          <div class="mt-2 text-sm text-gray-500">
                           ...
                           @endphp
                            ...
                            <div style="text-align: left">
                              ...
                              @else
                              <div class="rounded border shadow p-3 my-2 {{$sportSection->id == $sportSection->id ? 'bg-blue-200' : ''}}">
                              @endif
                                  <div class="justify-between my-2">
                                   <div>
                                       ...
                                       @endif
                                       @if ($sportSection['status']>0 && env('MENUE_MANNSCHAFTEN')<>"nein")
