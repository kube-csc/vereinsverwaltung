                  ...
                  <div class="p-6">
                      ...
                      <div class="ml-12">
                          <div class="mt-2 text-sm text-gray-500">
                              ...
                              <form autocomplete="off" action="{{ url('Abteilung/update/'.$sportSection->id) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @php
                                ...
                                <div class="my-4" >
                                    ...
                                    id="abteilungTeamBezeichnung" placeholder="Team Bezeichnung" name="abteilungTeamBezeichnung" value="{{ old('abteilungTeamBezeichnung') ?? $sportSection->abteilungTeamBezeichnung }}">
                                ...
                                <div class="my-4" >
                                    ...
                                    id="domain" placeholder="http://..." name="domain" value="{{ old('domain') ?? $sportSection->domain }}">
                                ...
                                <div class="my-4" >
                                    ...
                                    id="frabe" placeholder="205,16,118" name="farbe" value="{{ old('farbe') ?? $sportSection->farbe }}">
                                ...
                                <div class="my-4" >
                                    ...
                                    <textarea rows="25" cols="150" name="beschreibung" class="w-full rounded border shadow p-2 mr-2 my-2">{{ $ausgabetext }}</textarea>
