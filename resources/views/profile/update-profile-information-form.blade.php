<x-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="name" value="{{ __('Profilname') }}" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="vorname" type="text" class="mt-1 block w-full" wire:model="state.vorname" autocomplete="given-name" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="nachname" type="text" class="mt-1 block w-full" wire:model="state.nachname" autocomplete="family-name" />
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="telefon" type="text" class="mt-1 block w-full" wire:model="state.telefon" />
