            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
              ...
              <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                  <div class="mt-8 text-2xl">
                    Renntypen bearbeiten
                  </div>

                  <div class="mt-6 text-gray-500">
                   In diesem Bereich werden die Renntypen der Regatta bearbeitet.
                  </div>
                            ...
                            <div style="text-align: left">
                              ...
                              <div class="rounded border shadow p-3 my-2 bg-blue-200">
                                  <div class="justify-between my-2">
                                      <a class="ml-2 btn btn-sm btn-outline-primary" href="{{ url('/Rennklassen/edit/'.$raceType->id) }}">
                                  ...
                                  <div class="justify-between my-2">
                                    <div class="flex">
                                      ...
                                      <p class="mx-3 py-1 text-xs text-gray-500 font-semibold">{{ $raceType->updated_at->diffForHumans() }}</p>
                                    </div>
