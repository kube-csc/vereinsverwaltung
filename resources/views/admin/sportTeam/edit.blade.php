            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
              ...
              <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                  <div class="mt-8 text-2xl">
                      {{ env('MENUE_MANNSCHAFTEN') }}: {{ old('abteilung') ?? $sportTeam->abteilung }}
                  </div>
                  ...
                  <div class="mt-6 text-gray-500">
                    ...
                    @endphp
                    Bitte gebe die Daten von {{ env('MENUE_MANNSCHAFTEN') }} ein.
                  </div>
              </div>
              ...
              <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
                  <div class="p-6">
                      <div class="flex items-center">
                        <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold">{{ env('MENUE_MANNSCHAFTEN') }} bearbeiten</div>
                      </div>
                          ...
                          <div class="mt-2 text-sm text-gray-500">
                              ...
                              <form autocomplete="off" action="{{ url('Mannschaft/update/'.$sportTeam->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="my-4" >
                                    ...
                                    id="abteilung" placeholder="{{ env('MENUE_MANNSCHAFTEN') }}" name="abteilung" value="{{ old('abteilung') ?? $sportTeam->abteilung }}">
